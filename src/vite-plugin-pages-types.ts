/**
 * Keep this file in sync with https://github.com/hannoeru/vite-plugin-pages
 */
...
export { CustomBlock, ImportMode, ImportModeResolver, InternalPageResolvers, Optional, PageContext, PageOptions, PageResolver, ReactRoute, ResolvedOptions, SolidRoute, UserOptions, VueRoute, syncIndexResolver };
